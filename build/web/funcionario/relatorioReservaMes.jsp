<%-- 
    Document   : relatorioReservaMes
    Created on : 25/08/2020, 17:48:37
    Author     : Gabriel
--%>
...
<html>
    ...
    <body>
        <div class="container">
            <h1 class="my-4">Reservas do mês ${mes}</h1>
            <p class="badge-success"><b>${lista.size()}</b> reservas ocorreram neste mês</p>
            <p>Exportar em:</p>
